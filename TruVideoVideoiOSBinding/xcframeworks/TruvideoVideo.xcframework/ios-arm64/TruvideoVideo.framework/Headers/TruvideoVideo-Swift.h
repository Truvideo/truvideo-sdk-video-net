...
#ifndef TRUVIDEOVIDEO_SWIFT_H
#define TRUVIDEOVIDEO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TruvideoVideo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
- (nonnull instancetype)initWithUrl:(NSURL * _Nonnull)url position:(NSNumber * _Nullable)position width:(NSNumber * _Nullable)width height:(NSNumber * _Nullable)height outputURL:(NSURL * _Nonnull)outputURL OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
- (void)concatVideosWithInput:(NSArray<NSURL *> * _Nonnull)input output:(NSURL * _Nonnull)output completion:(void (^ _Nonnull)(TruvideoVideoSdkRequest * _Nullable, NSError * _Nullable))completion;
- (void)mergeVideosWithInput:(NSArray<NSURL *> * _Nonnull)input output:(NSURL * _Nonnull)output width:(NSNumber * _Nullable)width height:(NSNumber * _Nullable)height frameRate:(enum VideoFrameRate)frameRate completion:(void (^ _Nonnull)(TruvideoVideoSdkRequest * _Nullable, NSError * _Nullable))completion;
- (void)encodeVideoWithInput:(NSURL * _Nonnull)input output:(NSURL * _Nonnull)output width:(NSNumber * _Nullable)width height:(NSNumber * _Nullable)height frameRate:(enum VideoFrameRate)frameRate completion:(void (^ _Nonnull)(TruvideoVideoSdkRequest * _Nullable, NSError * _Nullable))completion;
...
- (void)getRequestByIdWithId:(NSString * _Nonnull)id completion:(void (^ _Nonnull)(TruvideoVideoSdkRequest * _Nullable, NSError * _Nullable))completion;
- (void)processWithId:(NSString * _Nonnull)id completion:(void (^ _Nonnull)(TruvideoVideoSdkRequest * _Nullable, NSError * _Nullable))completion;
- (void)cancelWithId:(NSString * _Nonnull)id completion:(void (^ _Nonnull)(TruvideoVideoSdkRequest * _Nullable, NSError * _Nullable))completion;
- (void)getVideoInfoWithInput:(NSURL * _Nonnull)input completion:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nullable, NSError * _Nullable))completion;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class NSUUID;
enum VideoRequestType : NSInteger;
@class NSDate;
SWIFT_CLASS("_TtC13TruvideoVideo23TruvideoVideoSdkRequest")
@interface TruvideoVideoSdkRequest : NSObject
@property (nonatomic, readonly, strong) NSUUID * _Nonnull id;
@property (nonatomic, readonly) enum VideoRequestType type;
@property (nonatomic, readonly) enum VideoRequestStatus status;
...
@property (nonatomic, readonly, copy) NSURL * _Nullable outputPath;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
typedef SWIFT_ENUM(NSInteger, VideoRequestType, open) {
  VideoRequestTypeEncode = 0,
  VideoRequestTypeMerge = 1,
  VideoRequestTypeConcat = 2,
};
